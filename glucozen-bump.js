( function ( global ) {
  ...
  var IMAGES = {
    '2': 'https://files.manuscdn.com/user_upload_by_module/session_file/310419663028428251/wgusmbjyiwJbOCdU.webp',
    '3': 'https://files.manuscdn.com/user_upload_by_module/session_file/310419663028428251/eSCIvPyQhxuOeDxz.webp',
    '6': 'https://files.manuscdn.com/user_upload_by_module/session_file/310419663028428251/XQSSRWLRwdfAdtyz.webp'
  };
  ...
  // ── Guarantee badge ──────────────────────────────────────────────────────
  // GlucoZen colors: teal #0a7a8f, light blue #5bc8d8
  var BADGE_SVG = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 90 90" width="72" height="72">'
    + '<circle cx="45" cy="45" r="43" fill="#5bc8d8" stroke="#a8e6ef" stroke-width="2"/>'
    + '<circle cx="45" cy="45" r="36" fill="#0a7a8f"/>'
    + '<text x="45" y="30" text-anchor="middle" font-family="Arial" font-size="8" font-weight="bold" fill="#a8e6ef">MONEY BACK</text>'
    + '<text x="45" y="48" text-anchor="middle" font-family="Arial" font-size="16" font-weight="bold" fill="#ffffff">100%</text>'
    + '<text x="45" y="62" text-anchor="middle" font-family="Arial" font-size="7.5" font-weight="bold" fill="#a8e6ef">GUARANTEED</text>'
    + '</svg>';
  ...
  // ── CSS — Variant A only (GlucoZen light blue palette) ─────────────────
  var CSS_A = `
    ...
    .vc-a-card:hover .vc-a-img-wrap img {
      ...
      filter: drop-shadow(0 0 16px rgba(91,200,216,0.45)) drop-shadow(0 8px 18px rgba(0,0,0,0.14));
    }
    .vc-a-card.vc-a-best {
      border-color: #5bc8d8;
      border-width: 2.5px;
    ...
    .vc-a-badge-top {
      ...
      background: linear-gradient(135deg, #0a7a8f 0%, #0a9ab5 100%);
      color: #fff;
      font-size: 15px;
      font-weight: 900;
      padding: 10px 36px;
      ...
      box-shadow: 0 4px 20px rgba(10,122,143,0.55), 0 0 0 3px #5bc8d8, 0 0 0 5px rgba(91,200,216,0.30);
    ...
    .vc-a-pill-save { background: linear-gradient(90deg, #5bc8d8, #0a9ab5); color: #fff; font-size: 12px; font-weight: 800; padding: 5px 14px; border-radius: 20px; white-space: nowrap; }
    ...
    @keyframes vc-a-btn-breathe {
      0%, 100% { box-shadow: 0 4px 14px rgba(91,200,216,0.35), 0 0 0 0 rgba(91,200,216,0); }
      50%       { box-shadow: 0 4px 20px rgba(91,200,216,0.55), 0 0 0 5px rgba(91,200,216,0.08); }
    }
    @keyframes vc-a-btn-best-breathe {
      0%, 100% { box-shadow: 0 4px 16px rgba(91,200,216,0.40), 0 0 0 0 rgba(91,200,216,0); }
      50%       { box-shadow: 0 4px 22px rgba(91,200,216,0.65), 0 0 0 5px rgba(91,200,216,0.12); }
    }
    .vc-a-btn {
      display: block;
      width: 100%;
      ...
      text-decoration: none;
      color: #fff;
      background: linear-gradient(135deg, #a8e6ef 0%, #5bc8d8 40%, #0a9ab5 100%);
      border: none;
      cursor: pointer;
      ...
      box-shadow: 0 4px 14px rgba(91,200,216,0.45), 0 1px 0 rgba(255,255,255,0.18) inset;
      margin-bottom: 4px;
      position: relative;
      overflow: hidden;
    ...
    .vc-a-btn:hover {
      ...
      box-shadow: 0 10px 28px rgba(91,200,216,0.65), 0 2px 8px rgba(0,0,0,0.12), 0 1px 0 rgba(255,255,255,0.20) inset;
      text-decoration: none;
      color: #fff;
      animation: none;
    }
    ...
    .vc-a-btn.vc-a-btn-best {
      background: linear-gradient(135deg, #a8e6ef 0%, #5bc8d8 45%, #0a7a8f 100%);
      box-shadow: 0 4px 16px rgba(91,200,216,0.50), 0 1px 0 rgba(255,255,255,0.15) inset;
      animation: vc-a-btn-best-breathe 2.4s ease-in-out infinite;
      color: #fff;
    }
    .vc-a-btn.vc-a-btn-best:hover {
      filter: brightness(1.10) saturate(1.12);
      box-shadow: 0 10px 30px rgba(91,200,216,0.70), 0 2px 8px rgba(0,0,0,0.14);
      animation: none;
    }
    ...
    .vc-a-total-now { font-weight: 900; color: #0a7a8f; font-size: 18px; }
    ...
    @keyframes vc-a-pulse {
      0%   { box-shadow: 0 12px 40px rgba(91,200,216,0.25), 0 4px 16px rgba(0,0,0,0.08); }
      50%  { box-shadow: 0 16px 50px rgba(91,200,216,0.42), 0 4px 16px rgba(0,0,0,0.08); }
      100% { box-shadow: 0 12px 40px rgba(91,200,216,0.25), 0 4px 16px rgba(0,0,0,0.08); }
    }
  ...
  global.GlucoZenBump = { render: render, renderA: renderA, init: init, version: VERSION };
