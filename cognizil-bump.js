( function ( global ) {
  ...
  var IMAGES = {
    '2': 'https://files.manuscdn.com/user_upload_by_module/session_file/310419663028428251/rNiqpXXlMJvtZjGL.png',
    '3': 'https://files.manuscdn.com/user_upload_by_module/session_file/310419663028428251/DyZSiWGhWKfmBkeU.png',
    '6': 'https://files.manuscdn.com/user_upload_by_module/session_file/310419663028428251/VWJmOYFkapwpskrs.png'
  };
  ...
  // ── Guarantee badge ──────────────────────────────────────────────────────
  // Cognizil colors: dark navy #0d1b4b, indigo-blue #2a3f8f, light blue-purple #7b8fd4
  var BADGE_SVG = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 90 90" width="72" height="72">'
    + '<circle cx="45" cy="45" r="43" fill="#2a3f8f" stroke="#7b8fd4" stroke-width="2"/>'
    + '<circle cx="45" cy="45" r="36" fill="#0d1b4b"/>'
    + '<text x="45" y="30" text-anchor="middle" font-family="Arial" font-size="8" font-weight="bold" fill="#7b8fd4">MONEY BACK</text>'
    + '<text x="45" y="48" text-anchor="middle" font-family="Arial" font-size="16" font-weight="bold" fill="#ffffff">100%</text>'
    + '<text x="45" y="62" text-anchor="middle" font-family="Arial" font-size="7.5" font-weight="bold" fill="#7b8fd4">GUARANTEED</text>'
    + '</svg>';
  ...
  // ── CSS — Variant A only (Cognizil dark navy/indigo palette) ──────────────
  var CSS_A = `
    ...
    .vc-a-card:not(.vc-a-best):hover {
      ...
      box-shadow: 0 16px 40px rgba(42,63,143,0.18), 0 4px 14px rgba(0,0,0,0.05);
      border-color: #2a3f8f;
      text-decoration: none;
      color: inherit;
    }
    .vc-a-card:hover .vc-a-img-wrap img {
      ...
      filter: drop-shadow(0 0 16px rgba(42,63,143,0.45)) drop-shadow(0 8px 18px rgba(0,0,0,0.14));
    }
    .vc-a-card.vc-a-best {
      border-color: #2a3f8f;
      border-width: 2.5px;
      background: linear-gradient(180deg, #ffffff 0%, #f0f3fc 60%, #e0e7f8 100%);
      color: #f0f0f0;
      box-shadow: 0 12px 40px rgba(42,63,143,0.35), 0 4px 16px rgba(0,0,0,0.20);
    ...
    .vc-a-card.vc-a-best:hover {
      ...
      border-color: #7b8fd4;
      border-width: 3px;
      box-shadow: 0 28px 60px rgba(42,63,143,0.45), 0 0 0 4px rgba(123,143,212,0.22), 0 6px 20px rgba(0,0,0,0.10);
    }
    ...
    .vc-a-card.vc-a-best .vc-a-card-header { border-color: rgba(42,63,143,0.35); }
    .vc-a-card.vc-a-best .vc-a-price-unit { color: #2a3f8f; }
    .vc-a-card.vc-a-best .vc-a-guarantee-text { color: #2a3f8f; }
    .vc-a-card.vc-a-best .vc-a-total-row { color: #0d1b4b; }
    .vc-a-card.vc-a-best .vc-a-total-label { color: #0d1b4b; }
    .vc-a-card.vc-a-best .vc-a-total-full { color: rgba(13,27,75,0.55); }
    .vc-a-card.vc-a-best .vc-a-total-now { color: #0d1b4b; }
    .vc-a-card.vc-a-best .vc-a-card-desc { color: #4a5a9a; }
    .vc-a-badge-top {
      position: absolute;
      top: -22px;
      left: 50%;
      transform: translateX(-50%);
      background: linear-gradient(135deg, #0d1b4b 0%, #2a3f8f 100%);
      color: #fff;
      font-size: 15px;
      font-weight: 900;
      padding: 10px 36px;
      ...
      box-shadow: 0 4px 20px rgba(13,27,75,0.55), 0 0 0 3px #2a3f8f, 0 0 0 5px rgba(123,143,212,0.30);
    ...
    .vc-a-card-header {
      width: 100%;
      padding-bottom: 16px;
      border-bottom: 1px solid #b2c0f2;
      margin-bottom: 16px;
    }
    .vc-a-card-headline { font-size: 20px; font-weight: 800; color: #0d1b4b; margin-bottom: 4px; }
    .vc-a-card:not(.vc-a-best) .vc-a-card-headline { color: #0d1b4b; }
    ...
    .vc-a-price-dollar { font-size: 24px; font-weight: 700; color: #2a3f8f; line-height: 1; }
    .vc-a-price-amount { font-size: 51px; font-weight: 900; color: #2a3f8f; line-height: 1; }
    .vc-a-card.vc-a-best .vc-a-price-dollar { font-size: 36px; font-weight: 900; color: #0d1b4b; }
    .vc-a-card.vc-a-best .vc-a-price-amount { font-size: 82px; font-weight: 900; color: #0d1b4b; }
    ...
    .vc-a-pill-save { background: linear-gradient(90deg, #2a3f8f, #0d1b4b); color: #fff; font-size: 12px; font-weight: 800; padding: 5px 14px; border-radius: 20px; white-space: nowrap; }
    ...
    @keyframes vc-a-btn-breathe {
      0%, 100% { box-shadow: 0 4px 14px rgba(42,63,143,0.35), 0 0 0 0 rgba(42,63,143,0); }
      50%       { box-shadow: 0 4px 20px rgba(42,63,143,0.55), 0 0 0 5px rgba(42,63,143,0.08); }
    }
    @keyframes vc-a-btn-best-breathe {
      0%, 100% { box-shadow: 0 4px 16px rgba(42,63,143,0.40), 0 0 0 0 rgba(42,63,143,0); }
      50%       { box-shadow: 0 4px 22px rgba(42,63,143,0.65), 0 0 0 5px rgba(42,63,143,0.12); }
    }
    .vc-a-btn {
      display: block;
      width: 100%;
      ...
      text-decoration: none;
      color: #fff;
      background: linear-gradient(135deg, #7b8fd4 0%, #2a3f8f 40%, #0d1b4b 100%);
      border: none;
      cursor: pointer;
      ...
      box-shadow: 0 4px 14px rgba(42,63,143,0.45), 0 1px 0 rgba(255,255,255,0.18) inset;
      margin-bottom: 4px;
      position: relative;
      overflow: hidden;
    ...
    .vc-a-btn:hover {
      ...
      box-shadow: 0 10px 28px rgba(42,63,143,0.65), 0 2px 8px rgba(0,0,0,0.12), 0 1px 0 rgba(255,255,255,0.20) inset;
      text-decoration: none;
      color: #fff;
      animation: none;
    }
    ...
    .vc-a-btn.vc-a-btn-best {
      background: linear-gradient(135deg, #7b8fd4 0%, #2a3f8f 45%, #0d1b4b 100%);
      box-shadow: 0 4px 16px rgba(42,63,143,0.50), 0 1px 0 rgba(255,255,255,0.15) inset;
      animation: vc-a-btn-best-breathe 2.4s ease-in-out infinite;
      color: #fff;
    }
    .vc-a-btn.vc-a-btn-best:hover {
      filter: brightness(1.10) saturate(1.12);
      box-shadow: 0 10px 30px rgba(42,63,143,0.70), 0 2px 8px rgba(0,0,0,0.14);
      animation: none;
    }
    ...
    .vc-a-total-now { font-weight: 900; color: #2a3f8f; font-size: 18px; }
    ...
    @keyframes vc-a-pulse {
      0%   { box-shadow: 0 12px 40px rgba(42,63,143,0.25), 0 4px 16px rgba(0,0,0,0.08); }
      50%  { box-shadow: 0 16px 50px rgba(42,63,143,0.42), 0 4px 16px rgba(0,0,0,0.08); }
      100% { box-shadow: 0 12px 40px rgba(42,63,143,0.25), 0 4px 16px rgba(0,0,0,0.08); }
    }
  ...
  global.CognizilBump = { render: render, renderA: renderA, init: init, version: VERSION };
