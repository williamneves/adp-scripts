( function ( global ) {
  ...
  var IMAGES = {
    '2': 'https://files.manuscdn.com/user_upload_by_module/session_file/310419663028428251/VrYAUYmnOvOBwlFa.png',
    '3': 'https://files.manuscdn.com/user_upload_by_module/session_file/310419663028428251/ZKocILiOdtvmWZkS.png',
    '6': 'https://files.manuscdn.com/user_upload_by_module/session_file/310419663028428251/vnsdkSjJnnxrlQkN.png'
  };
  ...
  // ── Guarantee badge ──────────────────────────────────────────────────────
  // Cognivex colors: deep purple #2d1b8e, lilac #7c5cbf
  ...
  // ── CSS — Variant A only (Cognivex deep purple + lilac palette) ─────────────────
  var CSS_A = `
    ...
    .vc-a-card:hover .vc-a-img-wrap img {
      ...
      filter: drop-shadow(0 0 16px rgba(124,92,191,0.45)) drop-shadow(0 8px 18px rgba(0,0,0,0.14));
    }
    .vc-a-card.vc-a-best {
      border-color: #7c5cbf;
      border-width: 2.5px;
    ...
    .vc-a-card.vc-a-best:hover {
      ...
      border-color: #c4a8f0;
      border-width: 3px;
      box-shadow: 0 28px 60px rgba(124,92,191,0.45), 0 0 0 4px rgba(196,168,240,0.22), 0 6px 20px rgba(0,0,0,0.10);
    }
    .vc-a-card.vc-a-best .vc-a-card-headline { color: #c4a8f0; }
    .vc-a-card.vc-a-best .vc-a-card-header { border-color: rgba(124,92,191,0.35); }
    ...
    .vc-a-badge-top {
      ...
      background: linear-gradient(135deg, #2d1b8e 0%, #4a2fa0 100%);
      color: #fff;
      font-size: 15px;
      font-weight: 900;
      padding: 10px 36px;
      ...
      box-shadow: 0 4px 20px rgba(45,27,142,0.55), 0 0 0 3px #7c5cbf, 0 0 0 5px rgba(124,92,191,0.30);
    ...
    .vc-a-card-headline { font-size: 20px; font-weight: 800; color: #2d1b8e; margin-bottom: 4px; }
    ...
    .vc-a-pill-save { background: linear-gradient(90deg, #7c5cbf, #3d2090); color: #fff; font-size: 12px; font-weight: 800; padding: 5px 14px; border-radius: 20px; white-space: nowrap; }
    ...
    @keyframes vc-a-btn-breathe {
      0%, 100% { box-shadow: 0 4px 14px rgba(124,92,191,0.35), 0 0 0 0 rgba(124,92,191,0); }
      50%       { box-shadow: 0 4px 20px rgba(124,92,191,0.55), 0 0 0 5px rgba(124,92,191,0.08); }
    }
    @keyframes vc-a-btn-best-breathe {
      0%, 100% { box-shadow: 0 4px 16px rgba(124,92,191,0.40), 0 0 0 0 rgba(124,92,191,0); }
      50%       { box-shadow: 0 4px 22px rgba(124,92,191,0.65), 0 0 0 5px rgba(124,92,191,0.12); }
    }
    .vc-a-btn {
      display: block;
      width: 100%;
      ...
      text-decoration: none;
      color: #fff;
      background: linear-gradient(135deg, #c4a8f0 0%, #7c5cbf 40%, #3d2090 100%);
      border: none;
      cursor: pointer;
      ...
      box-shadow: 0 4px 14px rgba(124,92,191,0.45), 0 1px 0 rgba(255,255,255,0.18) inset;
      margin-bottom: 4px;
      position: relative;
      overflow: hidden;
    ...
    .vc-a-btn:hover {
      ...
      box-shadow: 0 10px 28px rgba(124,92,191,0.65), 0 2px 8px rgba(0,0,0,0.12), 0 1px 0 rgba(255,255,255,0.20) inset;
      text-decoration: none;
      color: #fff;
      animation: none;
    }
    ...
    .vc-a-btn.vc-a-btn-best {
      background: linear-gradient(135deg, #c4a8f0 0%, #7c5cbf 45%, #3d2090 100%);
      box-shadow: 0 4px 16px rgba(124,92,191,0.50), 0 1px 0 rgba(255,255,255,0.15) inset;
      animation: vc-a-btn-best-breathe 2.4s ease-in-out infinite;
      color: #fff;
    }
    .vc-a-btn.vc-a-btn-best:hover {
      filter: brightness(1.10) saturate(1.12);
      box-shadow: 0 10px 30px rgba(124,92,191,0.70), 0 2px 8px rgba(0,0,0,0.14);
      animation: none;
    }
    ...
    .vc-a-total-now { font-weight: 900; color: #2d1b8e; font-size: 18px; }
    ...
    @keyframes vc-a-pulse {
      0%   { box-shadow: 0 12px 40px rgba(124,92,191,0.25), 0 4px 16px rgba(0,0,0,0.08); }
      50%  { box-shadow: 0 16px 50px rgba(124,92,191,0.42), 0 4px 16px rgba(0,0,0,0.08); }
      100% { box-shadow: 0 12px 40px rgba(124,92,191,0.25), 0 4px 16px rgba(0,0,0,0.08); }
    }
  ...
  global.CognivexBump = { render: render, renderA: renderA, init: init, version: VERSION };
